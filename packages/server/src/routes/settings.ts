...
function completeFeatures(value: unknown): DevHubFeatureFlags {
  ...
  return {
    ...
    taskRail: input.taskRail === true,
    taskHeaderSetup: input.taskHeaderSetup === true,
    threadWorkspace: input.threadWorkspace === true,
    composerSurface: input.composerSurface === true,
    inspectorDock: input.inspectorDock === true,
    searchCommands: input.searchCommands === true,
    settingsSecondary: input.settingsSecondary === true,
  ...
  properties: {
    ...
    devHubFeatures: {
      ...
      properties: {
        ...
        taskRail: { type: "boolean" },
        taskHeaderSetup: { type: "boolean" },
        threadWorkspace: { type: "boolean" },
        composerSurface: { type: "boolean" },
        inspectorDock: { type: "boolean" },
        searchCommands: { type: "boolean" },
        settingsSecondary: { type: "boolean" },
