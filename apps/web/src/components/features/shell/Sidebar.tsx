...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div className="dh-iconrail" data-dh-iconrail="" data-dh-drag="" onMouseDown={startWindowDrag}>
      ...
      >
        <div className="dh-panel-header" data-dh-drag="" onMouseDown={startWindowDrag}>
